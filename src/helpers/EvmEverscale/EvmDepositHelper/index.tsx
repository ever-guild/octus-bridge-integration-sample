...
type EvmDepositHelperProps =
    // We need (amount and destinationAddress) or (transactionHash)
    {
...
export const useEvmDepositHelper = (props: EvmDepositHelperProps): EvmDepositHelperData => {
    ...
    const {amount, destinationAddress, pipeline, transactionHash} = props;
                                        ...
                                        const depositLog =
                                            txReceipt.logs[
                                                decodedLogs.findIndex(
                                                    (log: any) => log !== undefined && log.name === 'Deposit',
                                                )
                                            ];
                            ...
                            return (
                                <div>
                                    ...
                                    <div
                                        ...
                                        onClick={() => {
                                            if (
                                                props.transferType === TransferType.Default &&
                                                pipeline.isLoaded &&
                                                amount &&
                                                destinationAddress
                                            ) {
